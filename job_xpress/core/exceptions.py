...
class SearchError(ServiceError):
    ...
    def __init__(
        ...
        super().__init__(
            error_code, message, "search_engine", details, original_exception
        )
...
class SearchAPIError(ExternalAPIError):
    ...
    def __init__(
        self, source: str, status_code: int, message: str = "Erreur API recherche"
    ):
        super().__init__(
...
class LLMResponseError(LLMError):
    ...
    def __init__(self, reason: str, raw_response: Optional[str] = None):
        super().__init__(
            ...
            details={
                "reason": reason,
                "raw_sample": raw_response[:200] if raw_response else None,
            },
        )
...
class LLMQuotaError(LLMError):
    ...
    def __init__(self):
        super().__init__(error_code="LLM-003", message="Quota DeepSeek dépassé")
...
class OCRError(ServiceError):
    ...
    def __init__(
        ...
        super().__init__(
            error_code, message, "ocr_service", details, original_exception
        )
...
class EmailError(ServiceError):
    ...
    def __init__(
        ...
        super().__init__(
            error_code, message, "email_service", details, original_exception
        )
...
class EmailSendError(EmailError):
    ...
    def __init__(
        self, recipient: str, status_code: Optional[int] = None, reason: str = ""
    ):
        super().__init__(
...
class PDFError(ServiceError):
    ...
    def __init__(
        ...
        super().__init__(
            error_code, message, "pdf_generator", details, original_exception
        )
