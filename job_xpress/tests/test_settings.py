...
def mock_supabase_client(mock_settings_data):
    ...
    eq_mock = MagicMock(
        return_value=MagicMock(execute=MagicMock(return_value=select_result))
    )
...
class TestSettingsEndpoints:
    ...
    def mock_auth(self):
        ...
        with (
            patch("api.settings_endpoints.get_required_token") as mock_token,
    ...
    def test_build_settings_response_with_defaults(self):
        ...
        # Données minimales
        minimal_data = {"id": "id-123", "user_id": "user-123"}
...
class TestSettingsValidation:
    ...
    def test_model_dump_excludes_none(self):
        ...
        update = UserSettingsUpdate(email_candidatures=True, language="en")
...
class TestResponseModels:
    ...
    def test_settings_update_response(self, mock_settings_data):
        ...
        response = SettingsUpdateResponse(
            success=True, message="Test message", settings=settings
        )
